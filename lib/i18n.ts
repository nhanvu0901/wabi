...
export const DICT: Record<string, { vi: string; en: string }> = {
  ...
  "sp.c3.t": { vi: "Cặp đôi · Art · Hướng nghiệp", en: "Couples · Art · Careers" },
  "sp.c3.b": { vi: "Tham vấn cặp đôi, trị liệu bằng nghệ thuật và định hướng nghề nghiệp cho tuổi trẻ.", en: "Couples counseling, art therapy, and career guidance for young people." },
  ...
  "sv4.t": { vi: "Art Therapy", en: "Art Therapy" },
  "sv4.badge": { vi: "Trị liệu bằng nghệ thuật", en: "Therapy through art" },
  "sv4.b": { vi: "Dùng công cụ nghệ thuật để khám phá và chữa lành cảm xúc — dành cho những ai muốn thể hiện bản thân theo cách không chỉ bằng lời nói. 60 phút mỗi buổi, có nhiều lựa chọn tiếp cận.", en: "Using art tools to explore and heal emotions — for those who want to express themselves in more than words. 60 minutes per session, with several approaches to choose from." },
  "sv4.tag": { vi: "Khám phá cảm xúc", en: "Emotional exploration" },
